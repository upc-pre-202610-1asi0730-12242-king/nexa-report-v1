...
Vue Router. (n.d.). *Vue Router and the Composition API*. Vue Router. https://router.vuejs.org/guide/advanced/composition-api.html

Vue.js. (n.d.). *Examples*. Vue.js. https://vuejs.org/examples/

Vue.js. (n.d.). *Reactivity fundamentals*. Vue.js. https://vuejs.org/guide/essentials/reactivity-fundamentals

Vue.js. (n.d.). *Routing*. Vue.js. https://v2.vuejs.org/v2/guide/routing
